...
const DraggableElement = ({ item, onSelect, addItemToDropZone }) => {
  ...
  return (
    <Rnd
      ...
      onResizeStop={(e, direction, ref, delta, position) => {
        ...
        console.log(delta, delta.width);
        // Log the new dimensions to see if they are being captured correctly
        console.log("Resized to:", width, height);

        onSelect(item.id, position.x, position.y, width, height); // Passer newWidth et height ici
        console.log(item.id, position.x, position.y, width, height);
      }}
      style={{
